  ...
  return (
    <section ref={sectionRef} id="processo" className="relative py-20 md:py-32 overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 md:px-16">
        ...
        >
          <CTAButton href="https://wa.me/5571981262448?text=Ol%C3%A1%2C%20vim%20do%20site%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es" target="_blank" rel="noopener noreferrer" label="Agendar minha visita" />
        </motion.div>
      </div>
    </section>
  );
