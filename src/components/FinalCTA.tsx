...
export function FinalCTASection() {
  return (
    <section className="relative z-10 w-full bg-gray-50 overflow-hidden min-h-[660px] md:min-h-[860px]">
      ...
      <div className="md:hidden absolute inset-0 flex items-center justify-center px-8">
        <div className="relative w-full max-w-[260px] h-[420px] rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="md:hidden absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 120% 55% at 50% 100%, rgba(249,250,251,1) 0%, rgba(249,250,251,0.8) 40%, transparent 65%)" }} />
      ...
      {/* Mobile text — centered at bottom */}
      <div className="md:hidden absolute inset-x-0 bottom-0 px-6 pb-12 text-center">
        <motion.h2
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="font-title text-2xl font-bold leading-tight mb-6 bg-gradient-to-r from-[#3FAEBC] to-[#0164A4] bg-clip-text text-transparent"
        >
