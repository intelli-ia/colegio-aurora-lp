            ...
            {props.testimonials.map(({ quote, author }, i) => (
              ...
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, s) => (
                    <svg key={s} className="w-3.5 h-3.5 text-[#FABD22]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#3FAEBC]/20 to-[#3FAEBC]/10 flex items-center justify-center flex-shrink-0">
                    <span className="text-[#3FAEBC] font-bold text-sm">{author.charAt(0)}</span>
                  </div>
